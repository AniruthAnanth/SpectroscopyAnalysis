...
wavelengths = np.linspace(529, 585, NUM_WAVELENGTHS + 1)
vocs = [
    ["C2H4", 0, 0.5, None],                 # Ethylene # 0.00005
    ["C2H4O2", 0, 0.5, None],               # Acetic acid # 0.00001
    ["C2H6", 0, 0.5, None],                 # Ethane # 0.00001
    ["C2H6O", 1, 0.5, None],                # Ethanol # 0.00006
    ["C3H6O", 1, 0.5, None],                # Acetone # 0.00007
    ["C3H8O", 1, 0.5, None],                # Propanol # 0.00002
    ["C4H8O2", 1, 0.5, None],               # Ethyl acetate # 0.00003
    ["C6H6", 1, 0.5, None],                 # Benzene # 0.00002
    ["C7H8", 1, 0.5, None],                 # Toluene # 0.00006
    ["C8H10", 0, 0.5, None],                # Xylene # 0.00003
    ["CH4", 0, 0.5, None],                  # Methane # 0.00017
    ["CH4O", 0, 0.5, None],                 # Methanol # 0.00005
]
